/* =========================
   ...
   (NO rompe lógica clínica existente)
========================= */

/* =========================
   META SEO POR SECCIÓN (HASH)
========================= */
const SEO_MAP = {
  "#ventilacion": {
    title: "Ventilación mecánica | Calculadora UCI Adultos",
    description:
      "Calculadora de ventilación mecánica para UCI adultos. Peso ideal, volumen corriente y ajuste de PCO₂ según objetivos clínicos."
  },
  "#ecocardiografia": {
    title: "Gasto cardíaco por ecocardiografía | Calculadora UCI",
    description:
      "Cálculo de gasto cardíaco por ecocardiografía (VTI TSVI) para evaluación hemodinámica en cuidados críticos."
  },
  "#oxigenacion": {
    title: "Oxigenación y transporte de O₂ | Calculadora UCI",
    description:
      "Cálculo de entrega, consumo y extracción de oxígeno (DO₂, VO₂, REO₂) en pacientes críticos."
  },
  "#perfusion": {
    title: "Perfusión y CO₂ | Calculadora UCI",
    description:
      "Gradiente veno-arterial de CO₂, RVS y presiones de perfusión para análisis hemodinámico avanzado."
  },
  "#acidobase": {
    title: "Estado ácido–base | Calculadora UCI",
    description:
      "Interpretación ácido–base, anion gap y delta gap en pacientes críticos adultos."
  },
  "#electrolitos": {
    title: "Electrolitos corregidos | Calculadora UCI",
    description:
      "Cálculo de sodio y calcio corregido según glucosa y albúmina sérica."
  },
  "#sofa": {
    title: "Calculadora SOFA-2 | UCI Adultos",
    description:
      "Calculadora SOFA-2 online para estimar disfunción orgánica y mortalidad en pacientes críticos adultos."
  }
};

function setMetaSEO(hash) {
  const cfg = SEO_MAP[hash];
  if (!cfg) return;
  document.title = cfg.title;
  const metaDesc = document.querySelector('meta[name="description"]');
  if (metaDesc) metaDesc.setAttribute("content", cfg.description);
  trackEvent("view_section", { section: hash.replace("#", "") });
}
